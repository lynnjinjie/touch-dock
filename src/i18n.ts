...
const en = {
  ...
  completePermissionPrompt: "Complete the macOS permission prompt",
  ...
  accessibilityHint: "Allow TouchDock in Accessibility settings",
...
const zhCN: Record<TranslationKey, string> = {
  ...
  requesting: "正在请求…", requestAccess: "请求权限", inputAccessGranted: "已获得输入控制权限", completePermissionPrompt: "请完成 macOS 权限设置",
  ...
  inputEnabled: "鼠标和键盘事件已启用", accessibilityHint: "请在辅助功能设置中允许 TouchDock", phoneCannotOpen: "手机无法打开页面？",
